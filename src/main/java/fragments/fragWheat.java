...
public class fragWheat extends Fragment {
    private static final String TAG = "fragWheat";
    private ListView listView;
    private View view;
    public List<Allergen> Wheat = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_frag_wheat, container, false);
    ...
    class lstViewAdapter extends ArrayAdapter {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            s.setText(Wheat.get(position).getAllergenDisc());
            s.setChecked(Wheat.get(position).getState());
            ...
            s.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    Allergen aTmp = Wheat.get(pos);
                    Wheat.get(pos).setState(isChecked);
                    id = aTmp.getAllergenID();
                    state = isChecked;
    ...
    private class GetAllergen extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String url = "https://comp-hons.uhi.ac.uk/~14023756/Hons/GetAllergen.php?Type=G&Uid=" + uid;
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < allergenArray.length(); i++) {
                        ...
                        Wheat.add(new Allergen(allergenObj.getString("disc"), "A", allergenObj.getInt("id"), allergenObj.getBoolean("state")));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            lstViewAdapter adapter = new lstViewAdapter(getActivity(), R.layout.lstview, Wheat.toArray());
    ...
    private class SetAllergen extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            Log.e(TAG, "db Ingredient - " + id + " ID :" + uid + "  has been set to :" + state);
