...
public class fragAdditives extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_frag_additives, container, false);
    ...
    private class GetAllergen extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String url = "https://comp-hons.uhi.ac.uk/~14023756/Hons/GetAllergen.php?Type=A&Uid=" + uid;
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < allergenArray.length(); i++) {
                        ...
                        Additives.add(new Allergen(allergenObj.getString("disc"), "A", allergenObj.getInt("id"), stmp == "true"?true:false));
